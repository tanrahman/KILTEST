...
void SWPAPDU_Dispatch(void)
{
	...
	G_APDUBuf[G_APDULen+1] = (unsigned char)(SW1SW2_SWP>>8);
	G_APDUBuf[G_APDULen+2] = (unsigned char)SW1SW2_SWP;
	G_APDULen += 0x02;
}
...
void SWPAPDU_Dispatch_APDU_GATE(void)
{
	...
	G_APDUGateLen = G_APDUGateBuf[4];
	
	G_APDUGateBuf[G_APDUGateLen] = (unsigned char)(SW1SW2_SWP_APDU_Gate >> 8);
	G_APDUGateBuf[G_APDUGateLen+1] = (unsigned char)SW1SW2_SWP_APDU_Gate;
	G_APDUGateLen += 0x02;
}
