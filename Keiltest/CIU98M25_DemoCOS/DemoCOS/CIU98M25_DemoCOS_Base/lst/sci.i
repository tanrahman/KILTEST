...
void SCI_Init(void)
{
    ...
    (*((volatile unsigned long *)( 0xE000E100 ))) = 1 << 8;
}
...
void SCI_Send_ATR(void)
{
	...
	for(i=1,tck=0;i<(*G_ATR);i++)
	{
        ...
        (*((volatile unsigned long *)(0x40001000 + 0x00 ))) = *(G_ATR+1+i);
		tck ^= *(G_ATR+1+i);
	}
	
    (*((volatile unsigned long *)(0x40001000 + 0x00 ))) = tck;        
}
...
void SCI_RxStart(void)
{
	while((*((volatile unsigned long *)(0x40001000 + 0x08 ))) & (1ul<<5));

	while((*((volatile unsigned long *)(0x40001000 + 0x08 ))) & (1ul<<3));
    
    (*((volatile unsigned long *)(0x40001000 + 0x14 ))) = 0x100;
    (*((volatile unsigned long *)( 0xE000E100 ))) = 1 << 10;
}
...
void SCI_StartTx_INT(unsigned short index)
{
	...
	(*((volatile unsigned long *)(0x40001000 + 0x10 ))) |= (1ul<<0);
	while(((*((volatile unsigned long *)(0x40001000 + 0x10 ))) & (1ul<<0)) == 1);
    ...
    else
    {
        for(i=0;i<SCILeLength;i++)
        {
            ...
            (*((volatile unsigned long *)(0x40001000 + 0x00 ))) = SCIAPDUBuf[G_SCISendIndex];
            G_SCISendIndex++;
        } 
    }
    
    (*((volatile unsigned long *)( 0xE000E280 ))) |= 1 << 9;
...
void SCI_StoreNBytes(void)
{
	while(((*((volatile unsigned long *)(0x40001000 + 0x14 ))) & (1ul<<1)) == 0)
    {
		if(G_SCIRecieveIndex >= 260)
		{
			return;
		}

        *(SCIAPDUBuf + G_SCIRecieveIndex) =(unsigned char)(*((volatile unsigned long *)(0x40001000 + 0x00 )));
        G_SCIRecieveIndex++;
    }
}
...
void HED_T0_SendByte(unsigned char byte)
{
    ...
    (*((volatile unsigned long *)(0x40001000 + 0x10 ))) |= (1ul<<0);
    while(((*((volatile unsigned long *)(0x40001000 + 0x10 ))) & 0x00000001) == 1);
    
    (*((volatile unsigned long *)(0x40001000 + 0x08 ))) = 0;

	(*((volatile unsigned long *)(0x40001000 + 0x00 ))) = byte;
	while(((*((volatile unsigned long *)(0x40001000 + 0x08 ))) & (1ul<<4)) == 0);
