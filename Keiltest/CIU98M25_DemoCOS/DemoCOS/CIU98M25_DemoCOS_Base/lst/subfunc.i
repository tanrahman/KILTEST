	...
	if (pck == 0)
	{
		...
		if ((SCIAPDUBuf[1] & 0x9F) == 0x10) 
		{
            ...
            if (SCIAPDUBuf[2] == 0x96)
			{
				...
				SCIAPDUBuf[1] = 0x10;
				SCIAPDUBuf[3] = 0x79;
				HED_T0_SendByte(SCIAPDUBuf[0]);
				HED_T0_SendByte(SCIAPDUBuf[1]);
				HED_T0_SendByte(SCIAPDUBuf[2]);
				HED_T0_SendByte(SCIAPDUBuf[3]);
...
void UID_Init(void)
{
    ...
    aReg_CardRFTypeA_UID[0] = 0x04;
    aReg_CardRFTypeA_UID[1] = *((unsigned char *)(0x1FFFFE00+0x20+0));
    aReg_CardRFTypeA_UID[2] = *((unsigned char *)(0x1FFFFE00+0x20+1));
    aReg_CardRFTypeA_UID[3] = *((unsigned char *)(0x1FFFFE00+0x20+2));
    aReg_CardRFTypeA_UID[4] = *((unsigned char *)(0x1FFFFE00+0x20+3));
}
